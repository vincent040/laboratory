...
QT_MOC_LITERAL(3, 16, 10), // "publicSlot"
QT_MOC_LITERAL(4, 27, 13), // "protectedSlot"
QT_MOC_LITERAL(5, 41, 11) // "privateSlot"

    },
    "example\0signal\0\0publicSlot\0protectedSlot\0"
    "privateSlot"
};
...
void example::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { int _r = _t->publicSlot();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 2: { int _r = _t->protectedSlot();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 3: { int _r = _t->privateSlot();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&example::signal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject example::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_example.data,
      qt_meta_data_example,  qt_static_metacall, nullptr, nullptr}
};
